        ...
        for statFile in sorted(os.listdir(targetDirectory), reverse=True):
            if os.path.splitext(statFile)[1].lower() == '.txt' and statFile[0:3] == '201':
                ...
                if os.path.isfile(targetDirectory + os.path.splitext(statFile)[0].lower() + ".jsonl"):
                    self.log.info(
                        "statsConsolidate.convertTxtArchive(): Json counterpart exists, deleting... " + statFile)
                ...
                for configTime in configObjStatsFile.keys():
                    ...
                    if configTime == 'PicDirScan':
                        ...
                        dateString = configTime[0:4] + "/" + configTime[4:6] + "/" + configTime[6:8] + "/" + configTime[
                                                                                                             8:10] + "/" + configTime[
                                                                                                                           10:12] + "/" + configTime[
                                                                                                                                          12:14]
                        ...
                        with open(targetDirectory + os.path.splitext(statFile)[0].lower() + ".jsonl",
                                  "a") as systemStatsFile:
