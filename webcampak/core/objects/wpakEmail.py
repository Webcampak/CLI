...
class Email(object):
    ...
    def __init__(self, log, dir_emails=None, dir_schemas=None):
        ...
        self.log.info(
            "emailObj(): Setting default filename to: %(em_fp)s"
            % {"em_fp": self.__email_filepath}
        )
        ...
        self.default = Default(
            self.log,
            schema_filepath=self.__dir_schemas + "emails.json",
            object_filepath=self.__email_filepath,
        )
